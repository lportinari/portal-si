# Generated by Django 3.0 on 2020-02-18 11:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('panpharma_homolog', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='CodelistsPanHomol',
            fields=[
                ...
                ('codigo_cliente', models.CharField(max_length=100, unique=True, verbose_name='Usuário a sercadastrado')),
        ...
        migrations.AlterField(
            model_name='teste',
            name='mapa',
            field=models.CharField(choices=[('', ''), ('Angeloni', 'Angeloni'), ('Catarinensecialatino', 'Catarinensecialatino'), ('Consys3', 'Consys3'), ('Consys8', 'Consys8'), ('Cooper', 'Cooper'), ('Drogal', 'Drogal'), ('EDM2', 'EDM2'), ('Eurofarma2', 'Eurofarma2'), ('Eurofarma3', 'Eurofarma3'), ('Farma01', 'Farma01'), ('Febrafar', 'Febrafar'), ('Fidelize2', 'Fidelize2'), ('Gestao40', 'Gestao40'), ('Mantercorp', 'Mantercorp'), ('Mercanet', 'Mercanet'), ('Nissei', 'Nissei'), ('PanarelloCli', 'PanarelloCli'), ('PanarelloExt2', 'PanarelloExt2'), ('PanarelloExt3', 'PanarelloExt3'), ('PdvLink', 'PdvLink'), ('PedPoa', 'PedPoa'), ('Permanente', 'Permanente'), ('Pharmalink', 'Pharmalink'), ('Pharmalink11', 'Pharmalink11'), ('Pharmalink3', 'Pharmalink3'), ('PharmalinkFidelize', 'PharmalinkFidelize'), ('Prodoctor', 'Prodoctor'), ('Rosario', 'Rosario'), ('Rosario01', 'Rosario01'), ('Rosario02', 'Rosario02'), ('SantaCruz4', 'SantaCruz4'), ('SantaCruz5', 'SantaCruz5'), ('Sintegra2', 'Sintegra2'), ('Sudestefarma', 'Sudestefarma')], max_length=100, verbose_name='Mapa'),
        ),
        migrations.AlterField(
            model_name='teste',
            name='move_arq_preco',
            field=models.BooleanField(choices=[('', ''), (0, 0), (1, 1)], verbose_name='Move ARQ preço?'),
        ),
        migrations.AlterField(
            model_name='teste',
            name='quebra',
            field=models.CharField(choices=[('', ''), ('Sim', 'Sim'), ('Não', 'Não')], max_length=20, verbose_name='Quebra'),
        ),
        migrations.AlterField(
            model_name='teste',
            name='sobrepoe_nf',
            field=models.BooleanField(choices=[('', ''), (0, 0), (1, 1)], verbose_name='Sobrepões NF?'),
        ),
        migrations.AlterField(
            model_name='teste',
            name='usuario_arquivo_preco',
            field=models.CharField(max_length=100, verbose_name='Usuário Arquivo Preço'),
        ),
        migrations.AlterField(
            model_name='teste',
            name='van',
            field=models.CharField(choices=[('', ''), ('BRAIR', 'BRAIR'), ('ENTIRE', 'ENTIRE'), ('ENTIRESI', 'ENTIRESI'), ('EPHARMA', 'EPHARMA'), ('FEBRAFAR', 'FEBRAFAR'), ('Fidelize', 'Fidelize'), ('FIDELIZE', 'FIDELIZE'), ('FOCOPDV', 'FOCOPDV'), ('IMS', 'IMS'), ('MERCANET', 'MERCANET'), ('MOST', 'MOST'), ('NISSEI', 'NISSEI'), ('ORIZON', 'ORIZON'), ('PHARMALINK', 'PHARMALINK'), ('PRODOCTOR', 'PRODOCTOR'), ('RAIA', 'RAIA'), ('RUNN', 'RUNN'), ('VIDALINK', 'VIDALINK'), ('VISAO', 'VISAO')], max_length=100, verbose_name='Van'),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='apontador',
            field=models.CharField(max_length=100, verbose_name='Apontador'),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='diretorio_arq_preco',
            field=models.CharField(max_length=100, verbose_name='Diretório ARQ Preço'),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='extensao_nf',
            field=models.CharField(choices=[('', ''), ('nfs', 'nfs'), ('not', 'not'), ('txt', 'txt')], max_length=10, verbose_name='Extensão Nota Fiscal'),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='extensao_retorno_itens_atendidos',
            field=models.CharField(choices=[('', ''), ('fal', 'fal'), ('not', 'not'), ('ret', 'ret'), ('txt', 'txt')], max_length=10),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='extensao_retorno_itens_nao_atendidos',
            field=models.CharField(choices=[('', ''), ('fal', 'fal'), ('not', 'not'), ('ret', 'ret'), ('txt', 'txt')], max_length=10),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
        ...
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='mapa_retorno_atendidos',
            field=models.CharField(choices=[('', ''), ('Drogal_Atendidos', 'Drogal_Atendidos'), ('Drogal_Atendidos_Contabiliza', 'Drogal_Atendidos_Contabiliza'), ('EDM2', 'EDM2'), ('Fidelize2', 'Fidelize2'), ('PanarelloCli_Atendidos', 'PanarelloCli_Atendidos'), ('PanarelloExt2_Atendidos', 'PanarelloExt2_Atendidos'), ('PdvLink', 'PdvLink'), ('PanarelloExt3_Atendidos', 'PanarelloExt3_Atendidos'), ('PharmalinkFidelize', 'PharmalinkFidelize'), ('Pharmalink3', 'Pharmalink3'), ('Pharmalink11', 'Pharmalink11'), ('PedPoa_Atendidos', 'PedPoa_Atendidos'), ('Permanente', 'Permanente'), ('Rosario_Atendidos', 'Rosario_Atendidos'), ('Rosario01', 'Rosario01'), ('Rosario02', 'Rosario02'), ('Rosario_Atendidos_Contabiliza', 'Rosario_Atendidos_Contabiliza'), ('SantaCruz5', 'SantaCruz5'), ('Sudestefarma_Atendidos', 'Sudestefarma_Atendidos'), ('Sintegra2', 'Sintegra2')], max_length=100),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='mapa_retorno_nao_atendidos',
            field=models.CharField(choices=[('', ''), ('Drogal_NaoAtendidos', 'Drogal_NaoAtendidos'), ('Drogal_NaoAtendidos_Contabiliza', 'Drogal_NaoAtendidos_Contabiliza'), ('EDM2', 'EDM2'), ('PanarelloCli_NaoAtendidos', 'PanarelloCli_NaoAtendidos'), ('PanarelloExt2_NaoAtendidos', 'PanarelloExt2_NaoAtendidos'), ('PanarelloExt3_NaoAtendidos', 'PanarelloExt3_NaoAtendidos'), ('PedPoa_NaoAtendidos', 'PedPoa_NaoAtendidos'), ('Permanente', 'Permanente'), ('PdvLink', 'PdvLink'), ('Pharmalink11', 'Pharmalink11'), ('Rosario_NaoAtendidos', 'Rosario_NaoAtendidos'), ('Rosario02', 'Rosario02'), ('Rosario_NaoAtendidos_Contabiliza', 'Rosario_NaoAtendidos_Contabiliza'), ('SantaCruz5', 'SantaCruz5'), ('Sudestefarma_NaoAtendidos', 'Sudestefarma_NaoAtendidos'), ('Sintegra2', 'Sintegra2')], max_length=100),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='mapa_retorno_nf',
            field=models.CharField(choices=[('', ''), ('Eurofarma2', 'Eurofarma2'), ('Fidelize2', 'Fidelize2'), ('Focopdv', 'Focopdv'), ('Mantercorp', 'Mantercorp'), ('Mercanet', 'Mercanet'), ('PanarelloExt2', 'PanarelloExt2'), ('Pharmalink', 'Pharmalink'), ('Pharmalink11', 'Pharmalink11'), ('Pharmalink3', 'Pharmalink3'), ('PharmalinkFidelize', 'PharmalinkFidelize'), ('Phl', 'Phl'), ('Prodoctor', 'Prodoctor'), ('Running', 'Running')], max_length=100),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='mascara_nf',
            field=models.CharField(max_length=100, verbose_name='Máscara Nota Fiscal'),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='mascara_remessa_arq_preco',
            field=models.CharField(max_length=100, verbose_name='Máscara Remessa ARQ Preço'),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='move_arq_preco',
        ...
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='sobrepoe_arquivo',
            field=models.CharField(choices=[('', ''), ('Sim', 'Sim'), ('Não', 'Não')], max_length=10, verbose_name='Sobrepõe arquivo?'),
        ),
        migrations.AlterField(
            model_name='usuariospanhomol',
            name='sobrepoe_nf',
